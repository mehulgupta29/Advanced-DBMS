...
public class GenerateJavaSource {
	...
	private static final String MF_STRUCTURE_ClASSNAME = Constants.MF_STRUCTURE_CLASSNAME;
	private static final String QUERY_PROCESSOR_CLASSNAME = Constants.QUERY_PROCESSOR_CLASSNAME;
	private static final String QUERY_PROCESSOR_FILEPATH = Constants.QUERY_PROCESSOR_FILEPATH;
	private static final String QP_MFTABLE_FIELD = Constants.QP_MFTABLE_FIELD;
	private static final String PACKAGE_NAME = Constants.PACKAGE_NAME;
	private static final String MF_STRUCTURE_FILEPATH = Constants.MF_STRUCTURE_FILEPATH;

	/**
	 * This function generates the MfStructure.java file
	 * @param mftableDataTypeMap
	 * @return
	 */
	public static boolean generateMfStructureClass(
			Map<String, String> mftableDataTypeMap) {

		File file = new File(MF_STRUCTURE_FILEPATH); //object for output file
		PrintWriter pw = null;
		try {
			...
			//write all the required variables from the mftableDataTypeMap Map.
	...
	/**
	 * This function generates the QP.java file
	 * @param input
	 * @param mfDataTypeMap
	 * @return
	 */
	public static boolean generateQPClass(Map<String, String> input,
		...
		//loop for each item in the mf structure
		...
		for (Entry<String, String> entry : entries) {
			...
			if (k.startsWith("sum") || k.startsWith("count")
					...
					|| k.startsWith("avg")) {
				String str = "";
				int count = Util.countMatches(k, "_"); //count the number of "_" in the variable name to between grouping attributes and grouping variables
				...
				//add the grouping variable number to the array list
